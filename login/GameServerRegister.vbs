...
'Generate command.
command = path & "java " & parameters & " -cp ./../libs/* com.l2journey.tools.gsregistering.BaseGameServerRegister"
If window = 1 Then
	command = "cmd /c start ""-Syntax-Dev - GameServer Register"" " & command
End If
